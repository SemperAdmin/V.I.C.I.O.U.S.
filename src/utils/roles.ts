export const normalizeOrgRole = (role?: string): 'Unit_Admin' | 'Unit_Manager' | 'Company_Manager' | 'Section_Manager' | 'Member' | 'App_Admin' | 'Insta_Admin' | '' => {
  ...
  if (r === 'insta_admin' || r === 'instaadmin' || r === 'installation_admin') return 'Insta_Admin'
