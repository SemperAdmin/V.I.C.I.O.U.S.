            ...
            <div className="flex flex-col items-center gap-4">
              <div className="bg-white p-4 rounded-lg qr-modal-svg flex flex-col items-center">
                ...
                <QRCodeSVG
                  ...
                  includeMargin={true}
                />
                <div className="text-black text-xs text-center mt-2">{import.meta.env.VITE_APP_NAME} by Semper Admin</div>
              </div>
                  ...
                  onClick={() => {
                    ...
                    img.onload = () => {
                      ...
                      if (ctx) {
                        ...
                        ctx.fillText(`${import.meta.env.VITE_APP_NAME} by Semper Admin`, canvas.width / 2, canvas.height - padding)
                      }
